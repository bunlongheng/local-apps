...
test('isSafePath requires absolute path, rejects shell/XML metachars', () => {
  assert.ok(isSafePath('/Users/YOU/Sites/app'));
...
test('isSafeLaunchAgentPath requires an absolute .plist with no metacharacters', () => {
  assert.ok(isSafeLaunchAgentPath('/Users/YOU/Library/LaunchAgents/com.bheng.foo.plist'));
  assert.ok(!isSafeLaunchAgentPath('/Users/YOU/x.txt'));

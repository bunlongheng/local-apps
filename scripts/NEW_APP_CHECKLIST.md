...
./scripts/onboard-app.sh <app-id> "<App Name>" $HOME/Sites/<app-id> --color R,G,B
```
...
- [ ] `gh repo create <your-github>/<app-id> --private --source=. --push`
...
- [ ] `cd $HOME/Sites/<app-id> && vercel link --yes`
- [ ] Push to deploy: `git push`
- [ ] Verify live at `https://<app-id>.vercel.app`
- [ ] Set homepage URL: `gh repo edit --homepage "https://<app-id>.vercel.app"`
...
- [ ] LAN URL works: `http://192.168.1.50:<port>`
- [ ] Prod URL works: `https://<app-id>.vercel.app`

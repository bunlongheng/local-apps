      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14, padding: "16px 18px", borderBottom: "1px solid var(--border, #27272a)" }}>
        ...
        {app.tabColor && (
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            {app.tabIcon && <span style={{ fontSize: 18 }}>{app.tabIcon}</span>}
            <div
              style={{
                width: 28,
                height: 28,
                borderRadius: 6,
                background: app.tabColor,
                border: "1px solid rgba(255,255,255,0.1)",
              }}
              title={`Tab: ${app.tabColor}`}
            />
          </div>
        )}
      </div>
    ...
    <>
      ...
      <div style={{ padding: 32 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24 }}>
          <h1 style={{ fontSize: 20, fontWeight: 700, color: "#fff" }}>Apps</h1>
          <div style={{ position: "relative" }}>
            <input
              ...
              style={{ background: "rgba(255,255,255,0.06)", border: "1px solid var(--border)", borderRadius: 8, padding: "6px 12px 6px 32px", fontSize: 12, color: "#fff", fontFamily: "inherit", width: 200, outline: "none" }}
            />
            <span style={{ position: "absolute", left: 10, top: "50%", transform: "translateY(-50%)", color: "var(--muted)", fontSize: 12 }}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
            </span>
            <kbd style={{ position: "absolute", right: 8, top: "50%", transform: "translateY(-50%)", fontSize: 9, color: "var(--muted)", background: "rgba(255,255,255,0.06)", padding: "2px 5px", borderRadius: 4, border: "1px solid rgba(255,255,255,0.1)" }}>&#8984;K</kbd>
          </div>
        </div>

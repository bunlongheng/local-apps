...
function decide({ remoteAddress, method, path, token, configuredToken, host, origin, allowedHosts = [] }) {
...
module.exports = { decide, isLoopback, tokenOk, hostAllowed, SENSITIVE_GET };

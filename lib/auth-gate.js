...
// GET (shell dotfiles, Claude config, logs) requires the configured token and is DENIED when
// no token is set. This closes unauthenticated LAN command-injection and secret reads even
// in the default (no-token) setup.
